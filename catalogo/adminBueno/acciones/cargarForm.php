...
if($_GET['form']=='item'){
	...
	header("location: ../items.php?slug=".$_GET['slug']);
	exit();
	}
	////////////////////////////////////////////////////////
...
header("location: ../categoria.php?slug=".$_GET['slug']."&idCat=".$_POST['idCat']."&idItem=".$_POST['idItem']);
exit();
}
//////CONTACTO//////////////////////////////////////////////////
...
if($_GET['form']=='producto'){ 
	...
	$sql = "UPDATE productos SET idCliente='".$_POST['idCliente']."',codigo='".$_POST['codigo']."',idCat='".$_POST['categoria']."',producto='".$_POST['producto']."',descripcion='".$_POST['descripcion']."',precio='".$_POST['precio']."',precioPromo='".$_POST['precioPromo']."' WHERE idProducto='".$_POST['idProducto']."'";
		$mysqli->query($sql);
		$id=$_POST['idProducto'];
	}else{
		$auditoria = "INSERT INTO productos (idCliente,idCat,codigo,producto,descripcion,precio,precioPromo,estado) VALUES ('".$_POST['idCliente']."','".$_POST['categoria']."','".$_POST['codigo']."','".$_POST['producto']."','".$_POST['descripcion']."','".$_POST['precio']."','".$_POST['precioPromo']."','1')";
		$mysqli->query($auditoria);
		$id = $mysqli->insert_id;
	}
////SUBIR IMAGEN////////////////
