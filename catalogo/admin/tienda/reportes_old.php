...
<div class="container">
  	<div style="padding-top:7px"><h3><a href="shopcar.php?slug=<?php echo SLUG ?>"><i class="fas fa-reply fa-lg"></i></a> | Categorías  | <font size="5" color="#999"><?php echo $item['item'] ?></font></h3></div> <hr>
