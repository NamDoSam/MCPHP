...
.login-form-font-header span {
  ...
  <body style="background-image:url(img/intro/intro_1.jpg)">
     <div class="container">
	   ...
	   <div class="col-md-12 login-form">
	      <form action="login/login.php" method="post">		
            ...
            <br><H5><font color="#72cff4">GESTION ADMINISTRATIVA</font></H5><br>
		       <p class="login-form-font-header"><img src="img/logo/logoLogin.png" width="250"></p>
