...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4">
      <form name="form1" method="post" action="cargarPedido.php?c=<?php echo SLUG ?>&envio=MESA&idCliente=<?php echo NUM_CLIENTE ?>&vendedor=<?php echo $_GET['vendedor'] ?>">
        <div align="center"> Mesa N°
          <input type="number" name="mesa" class="form-control input inputMesa" placeholder="0" value="<?php echo $_SESSION['sesiones'][4] ?>" required>
          <br>
          <button type="submit" class="btn btn-success">Cargar Mesa >></button>
        </div>
      </form>
    </div>
    <div class="col-sm-4"></div>
