...
if($_GET['modulo']=='categoria'){
    ...
    $mysqli->query($sql);
    header("location: ../categoria.php?slug=".$_GET['slug']."&idCat=".$_GET['idCat']."&idItem=".$_GET['idItem']);
    }
    //////////////////////////////////////////////////
    ...
    //$sql = "UPDATE promociones SET estado='".$_GET['estado']."' WHERE idPromo='".$_GET['idPromo']."'";
	$sql = "UPDATE productos SET promo='".$_GET['estado']."' WHERE idProducto=".$_GET['idProducto']."";
    $mysqli->query($sql);
