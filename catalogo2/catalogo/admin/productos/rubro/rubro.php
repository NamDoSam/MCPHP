...
<div class="container">
	<div style="padding-top:7px"><h3><?php echo RUBROS ?></h3></div><hr>
...
<table width="100%" border="0">
  <tr>
    <td><a href="Formulario_items.php?slug=<?php echo SLUG ?>&nvo=1"><button type="button" class="btn btn-secondary"><i class="fas fa-database" ></i> <?php echo BOTON_1 ?></button></a></td>
    <td align="right"><!--<a style="cursor:pointer;" data-toggle="modal" data-target="#myModal">
		<img class="ImgVideo" title="<?php echo VIDEO_3 ?>" src="../../img/videoTutorial.png" height="45px"></a>--></td>
  </tr>
</table>
<br>
...
<div class="row" style="background-color:#FFFFFF; border:1px #99CC00 solid">
	...
	<div class="col-6" style="padding: 10px;"><?php echo RUBROS ?></div>
...
<li class="ui-state-default" id="city_<?php echo $row['idItem']?>">
  ...
  <div class="row">
    ...
    <div class="col-6" style="padding: 7px; border-bottom:#CCC 1px solid"><?php echo $row['item']?></div>
    <div class="col-2" style="padding: 7px; border-bottom:#CCC 1px solid" align="center"><a href="categorias.php?slug=<?php echo SLUG ?>&idItem=<?php echo $row['idItem']?>"><i class="fas fa-sign-in-alt fa-lg"></i></a></div>
	<div class="col-1" style="padding: 7px; border-bottom:#CCC 1px solid" align="center">
	<a href="Formulario_items.php?slug=<?php echo SLUG ?>&idItem=<?php echo $row['idItem'] ?>"><font color="#FF00FF"><i class='fas fa-pencil-alt fa-lg'></i></font></a>
	</div>
	<div class="col-1" style="padding: 7px; border-bottom:#CCC 1px solid" align="center">
	<?php if($row['estado']==0){?>
...
<a href="acciones/estado.php?slug=<?php echo SLUG ?>&estado=0&modulo=items&idItem=<?php echo $row['idItem'] ?>"><font color='#FF0000'><i class='fa fa-eye fa-lg'></i></font></a>
	...
	<div class="col-1" style="padding: 7px; border-bottom:#CCC 1px solid" align="center">
	<a onclick="return confirmar()" href="acciones/borrarRegistros.php?slug=<?php echo SLUG ?>&idItem=<?php echo $row['idItem'] ?>&modulo=items"><font color="#CCCCCC"><i class='fa fa-trash fa-lg'></i></font></a>
	</div>
  </div>
</li>
<?php }?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo VIDEO_3 ?></h4>
      </div>
