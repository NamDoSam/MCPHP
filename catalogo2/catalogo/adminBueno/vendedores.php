...
<div class="form-group" align="right">
  <a href="Formulario_vendedor.php?slug=<?php echo SLUG ?>&idVendedor=0&idCliente=<?php echo NUM_CLIENTE ?>"><button type="button" class="btn btn-warning"><i class="fa fa-database" ></i> Nuevo Vendedor</button></a>
  &nbsp;&nbsp;&nbsp;&nbsp;
    <a style="cursor:pointer;" data-toggle="modal" data-target="#myModal">
      <img class="ImgVideo" title="Configuración general de la tienda" src="videoTuto.jpg" height="45px"></a>
