    ...
    <div class="panel panel-default">
      ...
      <form name="form2" method="post" action="delivery/guardarShopcar.php?accion=envio&slug=<?php echo SLUG ?>">
        ...
        <tr>
          ...
          <td colspan="2"><strong>Mínimo p/Envío $
        ...
        <tr>
         ...
         <tr>
         	<td colspan="1" align="right"><h4><strong>+54 9</strong></h4></td>
        	<td colspan="1"><input name="celPedido" class="form-control" placeholder="00000000000" type="number" value="<?php echo $row['celPedido'] ?>"></td>
             <td colspan="2">(Con el código de área, sin el 15 y sin espacios.)</td>
        </tr>
