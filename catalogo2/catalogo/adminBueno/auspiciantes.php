...
?>
		  ...
		  if($row['link']!=''){ $link=$row['link']; $target="target='_blank'"; }else{ $link='#'; $target='';}?>
                    ...
                    <td align="center"><a
                            ...
                            <font color='#3366CC'><i class='fa fa-pencil-square fa-lg'></i></font>
                        </a></td>

                    <td align="center"><?php if($row['estado']==0){?>
                        <a
                            href="acciones/estado.php?slug=<?php echo SLUG ?>&estado=1&modulo=esponsor&idEsponsor=<?php echo $row['idEsponsor'] ?>">
                            <font color='#00CC00'><i class='fa fa-eye fa-lg'></i></font>
                        </a>
                        <?php }else{?>
                        <a
                            href="acciones/estado.php?slug=<?php echo SLUG ?>&estado=0&modulo=esponsor&idEsponsor=<?php echo $row['idEsponsor'] ?>">
                    ...
                    <td align="center">
                        <a onclick="return confirmar()"
                            href="acciones/borrarRegistros.php?slug=<?php echo SLUG ?>&idEsponsor=<?php echo $row['idEsponsor'] ?>&modulo=esponsor">
