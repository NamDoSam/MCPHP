<?php require('template/cenefa.php'); ?>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="img/logos/logoLogin.png" alt="..." /></a>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">tu cataloto on-line - autogestionable</div>

                <div align="center"> 
                <div class="col-12 col-m-6 col-lg-6">
                <form method="POST" action="">
                    <select class="selectpicker form-control buscador" id="number" data-container="body" data-live-search="true" title="Select a number" data-hide-disabled="true"></select>
                </form>
                </div>
                </div>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-lg-3 col-sm-6 mb-4 mb-lg-0">
                        <!-- Portfolio item 4-->
                        <div class="portfolio-item">
                    ...
                    <div class="col-6 col-lg-3 col-sm-6 mb-4 mb-sm-0">
                        <!-- Portfolio item 5-->
                        <div class="portfolio-item">
