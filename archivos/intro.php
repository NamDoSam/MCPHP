...
if(file_exists($directorio)){?> 
	<div class="cuadroImg">    
   		<img src="<?php echo $directorio ?>" style="max-width:140px; max-height: 112px" alt="<?php echo $cli['nomFantasia'] ?>" /> 
    </div>
<?php }else{ ?>
	<img class="cuadroImg" src="catalogo/img/logo_qr/menucatalgo.png" height="100%" title="<?php echo $cli['nomFantasia'] ?>" /> 
<?php }?>           
           </a>
